...
namespace Homesite.Infrastructure.Services.Process
{
    ...
    {
        public IProjectParserResult ParseProjects(MemoryStream fileData)
        {
            IProjectParserResult result = new ProjectParserResult();
            ...
            try
            {
                ...
                using (ExcelPackage pkg = new ExcelPackage(fileData))
                {
                    ...
                    for (int row = 2; row <= endRangeAddress.Row; row++)
                    {
                        ...
                        {
                            ProjectParseRecord record = new ProjectParseRecord();
                            ...
                            result.ParsedProjects.Add(record);
                        }
                    }
